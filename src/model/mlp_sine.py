...
class MultiLayerPerceptronSine(Classifier):
    """
    A digit recognizer based on logistic regression algorithm
    ...
    def __init__(self, train, valid, test, hiddenLayers, outputDim, learningRate=0.01, epochs=30):
        ...
        self.epochs = epochs
        self.errorDeltaThreshold = 0.000001
    ...
    def trainSingleInput(self, input, target):
        ...
        for l in xrange(len(layerOutputs)-1, -1, -1):
            ...
            if downstreamSigmas is None: # i.e. this is the output layer
                ...
                sigmas = map(lambda t, o: (t - o) * self.layers[l].derivative(o), target, layerOutputs[l])
